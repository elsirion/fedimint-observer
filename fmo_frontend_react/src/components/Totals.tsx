...
export function Totals() {
  ...
  return (
    <div className="flex items-center justify-center space-x-10 dark:text-white">
      <div className="text-center">
        <div className="text-4xl font-bold mb-2">
          {loading ? 'Loading...' : formatNumber(totals?.federations || 0)}
        </div>
        <div className="text-gray-500">Observed Federations</div>
      </div>
      ...
      <div className="text-center">
        <div className="text-4xl font-bold dark:text-white mb-2">
          <svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-currency-bitcoin inline align-bottom"
            viewBox="0 0 16 16"
          >
